...
I posted some of the results below. It demonstrated average selected times of each informative edge. Their values, which are positive or negative, mean their signal signs in intelligence prediction. The color of the connection points corresponds to the networks they localize, and can be checked in [Kong's parcellaion](#rs-fMRI analysis)
