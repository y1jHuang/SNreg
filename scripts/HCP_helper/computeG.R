...
alpha = 1e-3
rootPath = getwd()
unrestricted = read.csv(file.path(rootPath, 'cogdf.csv'))
...
write.csv(b4Scores,'b4Scores_EFA.csv',row.names = FALSE)
...
write.csv(biScores,'biScores_CFA.csv',row.names = FALSE)
sink(NULL)
